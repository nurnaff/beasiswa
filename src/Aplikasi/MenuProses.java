...
public class MenuProses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROSES PENENTUAN BEASISWA");
...
public void isicombo() {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        if(((jComboBox4.getSelectedItem().toString().equals("PETANI")) || (jComboBox5.getSelectedItem().toString().equals("PETANI")) ) && (Double.parseDouble(jTextField7.getText())<600000) && (jComboBox17.getSelectedItem().toString().equals("ADA SEWA"))) {jLabel12.setText("Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("PETANI")) || (jComboBox5.getSelectedItem().toString().equals("PETANI")) ) && (Double.parseDouble(jTextField7.getText())<600000) && (jComboBox17.getSelectedItem().toString().equals("ADA 1"))) {jLabel12.setText("Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("PETANI")) || (jComboBox5.getSelectedItem().toString().equals("PETANI")) ) && (Double.parseDouble(jTextField7.getText())<1000000) && (jComboBox17.getSelectedItem().toString().equals("ADA >1"))) {jLabel12.setText("Tidak Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("SWASTA")) || (jComboBox5.getSelectedItem().toString().equals("SWASTA")) ) && (Double.parseDouble(jTextField7.getText())<1000000) && (jComboBox17.getSelectedItem().toString().equals("TIDAK ADA"))) {jLabel12.setText("Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("SWASTA")) || (jComboBox5.getSelectedItem().toString().equals("SWASTA")) ) && (Double.parseDouble(jTextField7.getText())<1000000) && (jComboBox17.getSelectedItem().toString().equals("TIDAK ADA")) && (Double.parseDouble(jTextField12.getText())>3)) {jLabel12.setText("Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("SWASTA")) || (jComboBox5.getSelectedItem().toString().equals("SWASTA")) ) && (Double.parseDouble(jTextField7.getText())>2500000) && (jComboBox7.getSelectedItem().toString().equals("MILIK SENDIRI")) && (Double.parseDouble(jTextField12.getText())<3)) {jLabel12.setText("Tidak Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("PNS")) || (jComboBox5.getSelectedItem().toString().equals("SWASTA")) ) && (Double.parseDouble(jTextField7.getText())>2500000) && (jComboBox17.getSelectedItem().toString().equals("ADA >1")) && (jComboBox12.getSelectedItem().toString().equals("50000-80000"))) {jLabel12.setText("Tidak Diterima");}
        else if(((jComboBox4.getSelectedItem().toString().equals("PETANI")) || (jComboBox5.getSelectedItem().toString().equals("PETANI")) ) && (Double.parseDouble(jTextField7.getText())<1000000) && (jComboBox7.getSelectedItem().toString().equals("KONTRAK/SEWA")) && (Double.parseDouble(jTextField12.getText())>3)) {jLabel12.setText("Diterima");}
        
    }//GEN-LAST:event_jButton6ActionPerformed
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuProses().setVisible(true);
            }
        });
    }
